    ...
    <h2 class="animate-text">PROJECTS</h2>
        <main class="project">
            ...
            <div class="underProject">
                ...
                <img class="imgProject" src="https://zupimages.net/up/21/11/xiq3.jpg" alt="New-york"/>
            </div>

            <div class="underproject">
                <h2 class="titleUnderProject">La Bretagne vous gagne</h2>
                <img class="imgProject" src="https://zupimages.net/up/21/11/a25u.jpg" alt="Bretagne Sea lighthouse"/>
